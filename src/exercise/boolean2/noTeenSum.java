...
//        Write a separate helper "public int fixTeen(int n) {"that takes in an int value
//        and returns that value fixed for the teen rule. In this way,
